...
async function main() {
  ...
  const poolContract500 = new Contract(WETH_USDC_500, UniswapV3Pool.abi, provider)
  const poolData500 = await getPoolData(poolContract500)
  console.log('poolData500', poolData500)

  const poolContract3000 = new Contract(WETH_USDC_3000, UniswapV3Pool.abi, provider)
  const poolData3000 = await getPoolData(poolContract3000)
  console.log('poolData3000', poolData3000)

  const poolContract10000 = new Contract(WETH_USDC_10000, UniswapV3Pool.abi, provider)
